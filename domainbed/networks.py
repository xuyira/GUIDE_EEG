...
from domainbed.feature_models import FeatureExtractor
import copy
...
class DinoV2(torch.nn.Module):
    ...
    def forward(self, x, num_layers=4):
...
class ResNet(torch.nn.Module):
    ...
    def forward(self, x, num_layers=4):
        ...
        # return self.dropout(self.network(x, num_layers=num_layers))
...
def ClusterFeaturizer(input_shape, hparams):
    return FeatureExtractor(hparams)
